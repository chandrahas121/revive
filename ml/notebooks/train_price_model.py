...
# Cleaning 'name_brand' and 'text_combined'...
# Vectorizing Text Features...
# Encoding Categorical Features...
# Stacking features into CSR matrix...
# Final Input Shape: (1481661, 150007)
# Saving train/val splits to disk for safety...

# === Training Model 1 (MLP-256) ===
# I0000 00:00:1781385552.961368      23 gpu_device.cc:2019] Created device /job:localhost/replica:0/task:0/device:GPU:0 with 13757 MB memory:  -> device: 0, name: Tesla T4, pci bus id: 0000:00:04.0, compute capability: 7.5
# I0000 00:00:1781385552.967100      23 gpu_device.cc:2019] Created device /job:localhost/replica:0/task:0/device:GPU:1 with 13757 MB memory:  -> device: 1, name: Tesla T4, pci bus id: 0000:00:05.0, compute capability: 7.5
# [ Epoch 1 ] started...
# WARNING: All log messages before absl::InitializeLog() is called are written to STDERR
# I0000 00:00:1781385556.508541      70 service.cc:152] XLA service 0x78f9380061a0 initialized for platform CUDA (this does not guarantee that XLA will be used). Devices:
# I0000 00:00:1781385556.508601      70 service.cc:160]   StreamExecutor device (0): Tesla T4, Compute Capability 7.5
# I0000 00:00:1781385556.508607      70 service.cc:160]   StreamExecutor device (1): Tesla T4, Compute Capability 7.5
# I0000 00:00:1781385556.917065      70 cuda_dnn.cc:529] Loaded cuDNN version 91002
# I0000 00:00:1781385559.513746      70 device_compiler.h:188] Compiled cluster using XLA!  This line is logged at most once for the lifetime of the process.
#   -> Batch 500/5209 | Current Loss: 1.0453
#   -> Batch 1000/5209 | Current Loss: 0.7374
#   -> Batch 1500/5209 | Current Loss: 0.6053
#   -> Batch 2000/5209 | Current Loss: 0.5284
#   -> Batch 2500/5209 | Current Loss: 0.4779
#   -> Batch 3000/5209 | Current Loss: 0.4415
#   -> Batch 3500/5209 | Current Loss: 0.4141
#   -> Batch 4000/5209 | Current Loss: 0.3928
#   -> Batch 4500/5209 | Current Loss: 0.3752
#   -> Batch 5000/5209 | Current Loss: 0.3608
# [ Epoch 1 ] Finished! | Train Loss: 0.3555 | Val Loss: 0.1994

# [ Epoch 2 ] started...
#   -> Batch 500/5209 | Current Loss: 0.1842
#   -> Batch 1000/5209 | Current Loss: 0.1855
#   -> Batch 1500/5209 | Current Loss: 0.1868
#   -> Batch 2000/5209 | Current Loss: 0.1875
#   -> Batch 2500/5209 | Current Loss: 0.1878
#   -> Batch 3000/5209 | Current Loss: 0.1885
#   -> Batch 3500/5209 | Current Loss: 0.1886
#   -> Batch 4000/5209 | Current Loss: 0.1887
#   -> Batch 4500/5209 | Current Loss: 0.1886
#   -> Batch 5000/5209 | Current Loss: 0.1885
# [ Epoch 2 ] Finished! | Train Loss: 0.1884 | Val Loss: 0.1824

# === Training Model 2 (MLP-1024) ===

# [ Epoch 1 ] started...
#   -> Batch 500/5209 | Current Loss: 0.6731
#   -> Batch 1000/5209 | Current Loss: 0.4993
#   -> Batch 1500/5209 | Current Loss: 0.4211
#   -> Batch 2000/5209 | Current Loss: 0.3770
#   -> Batch 2500/5209 | Current Loss: 0.3488
#   -> Batch 3000/5209 | Current Loss: 0.3290
#   -> Batch 3500/5209 | Current Loss: 0.3138
#   -> Batch 4000/5209 | Current Loss: 0.3022
#   -> Batch 4500/5209 | Current Loss: 0.2924
#   -> Batch 5000/5209 | Current Loss: 0.2845
# [ Epoch 1 ] Finished! | Train Loss: 0.2815 | Val Loss: 0.1984

# [ Epoch 2 ] started...
#   -> Batch 500/5209 | Current Loss: 0.1569
#   -> Batch 1000/5209 | Current Loss: 0.1597
#   -> Batch 1500/5209 | Current Loss: 0.1618
#   -> Batch 2000/5209 | Current Loss: 0.1631
#   -> Batch 2500/5209 | Current Loss: 0.1650
#   -> Batch 3000/5209 | Current Loss: 0.1669
#   -> Batch 3500/5209 | Current Loss: 0.1679
#   -> Batch 4000/5209 | Current Loss: 0.1688
#   -> Batch 4500/5209 | Current Loss: 0.1698
#   -> Batch 5000/5209 | Current Loss: 0.1704
# [ Epoch 2 ] Finished! | Train Loss: 0.1706 | Val Loss: 0.1810
...
# ==================================================
# FINAL ENSEMBLE CV RMSLE : 0.4157
# ==================================================