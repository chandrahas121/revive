    ...
    try {
      ...
      for (const [, file] of orderedPhotos) {
        ...
        if (url) {
          ...
          if (!coverSent) { formData.append('image', file); coverSent = true; }
