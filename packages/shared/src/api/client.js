...
export const sellerRegister = (payload) => api.post('/api/seller/auth/register/', payload);
export const sellerLogin    = (payload) => api.post('/api/seller/auth/login/', payload);
export const sellerLogout   = () => api.post('/api/seller/auth/logout/', {});
export const sellerMe       = () => api.get('/api/seller/auth/me/');
